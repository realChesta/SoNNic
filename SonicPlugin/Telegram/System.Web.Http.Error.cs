...
namespace System.Web.Http
{
    ...
    internal static class Error
    {
        ...
        {
            return new ArgumentException(Error.Format("Unsupported URI scheme: '{0}'. The URI scheme must be either '{1}' or '{2}'.", actualValue, HttpScheme, HttpsScheme), parameterName);
        }
        ...
        {
            return new ArgumentException(Error.Format("Relative URI values are not supported: '{0}'. The URI must be absolute.", actualValue), parameterName);
        }
        ...
        {
            return new ArgumentException(Error.Format("URI must not contain a query component or a fragment identifier.", actualValue), parameterName);
        }
        ...
        {
            return new ArgumentOutOfRangeException(parameterName, actualValue, Error.Format("Value must be greater than or equal to {0}", minValue));
        }
        ...
        {
            return new ArgumentOutOfRangeException(parameterName, actualValue, Error.Format("Value must be less than or equal to {0}", maxValue));
        }
