...
using SonicPlugin.NEAT.Genetics.MutationTypes;
...
namespace NEAT
{
    public class EvolutionController
    {
        ...
        public class SpeciesParameters
        {
            ...
            public const double DefaultAddInputMutationProbability = 0.001;
            ...
            public double AddInputNodeMutationProbability;
            ...
            public SpeciesParameters()
            {
                ...
                this.AddInputNodeMutationProbability = DefaultAddInputMutationProbability;
            ...
            public SpeciesParameters(double minWeight, double maxWeight, double eliteProportion, double selectionProportion, double mutationOffspringProportion,
                                     ...
                                     double addNodeProbability, double addConnectionProbability, double addInputProbability, double removeConnectionProbability, 
                                     IMutationInfo[] mutations)
            {
                ...
                this.AddNodeMutationProbability = addNodeProbability;
                this.AddConnectionMutationProbability = addConnectionProbability;
                this.AddInputNodeMutationProbability = addInputProbability;
            ...
            public IMutationInfo[] GetDefaultMutations2()
            {
                ...
                toReturn.Add(new AddNodeMutationInfo());
                toReturn.Add(new AddConnectionMutationInfo());
                toReturn.Add(new AddInputMutation());
